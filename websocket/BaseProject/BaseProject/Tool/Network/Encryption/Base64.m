...
+ (NSString *)base64EncodedStringFromString:(NSString *)string {
    NSData *data = [RC4 rc4:[[string dataUsingEncoding:NSUTF8StringEncoding] mutableCopy]
                        key:@"%r3fd)&ds~23ds1+;xJL"];
...
+ (NSString *)base64EncodedStringFromData:(NSData *)data {
    ...
    char *characters = (char *)calloc((([data length] + 2) / 3) * 4, sizeof(char));
    if (characters == NULL)
        return nil;
    NSUInteger length = 0;
